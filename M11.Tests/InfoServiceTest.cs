...
namespace M11.Tests
{
    ...
    {
        private static readonly GenericDatabase<MonthBillSummary> MonthBillSummaryDatabase =
            new GenericDatabase<MonthBillSummary>(".\\MonthBillSummarySQL.db3");
        ...
        {
            //var result = MonthBillSummaryDatabase.ClearAsync().Result;
